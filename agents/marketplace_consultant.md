...
- **create_skill**: Create a new skill (name, description, content, tags). Skills are automatically added to the user's plugin.
- **update_skill**: Update an existing skill by skill_id slug
...
All tools use **skill_id slugs** (e.g. 'odoo-customer-report') — NOT UUIDs. Use list_skills to find slugs.
